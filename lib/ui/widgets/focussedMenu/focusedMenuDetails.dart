                                                          ...
                                                          avatar: Icon(JamIcons.ordered_list,
                                                              color: HexColor(Provider.of<WallHavenProvider>(context, listen: false).wallsS[index].colors[Provider.of<WallHavenProvider>(context, listen: false).wallsS[index].colors.length - 1]).computeLuminance() > 0.5
                                                                  ...
                                                                  : Colors
                                                                      .white,
                                                              size: 20),
                                                          backgroundColor: HexColor(Provider.of<WallHavenProvider>(
                                                                  context,
                                                                  listen: false)
                                                              .wallsS[index]
                                                          ...
                                                          label: Text(
                                                            ...
                                                            style:
                                                                Theme.of(
                                                                    ...
                                                                    .headline4
                                                                    .copyWith(
                                                                      color: HexColor(Provider.of<WallHavenProvider>(context, listen: false).wallsS[index].colors[Provider.of<WallHavenProvider>(context, listen: false).wallsS[index].colors.length - 1]).computeLuminance() >
                                                                              0.5
                                                                          ? Colors
                                                                              .black
                                                                          : Colors
