...
_SetupDocDto _$SetupDocDtoFromJson(Map<String, dynamic> json) => _SetupDocDto(
  ...
  icon: json['icon'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['icon']),
  iconUrl: json['icon_url'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['icon_url']),
  ...
  image: json['image'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['image']),
  name: json['name'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['name']),
  userPhoto: json['userPhoto'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['userPhoto']),
  wallId: json['wall_id'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['wall_id']),
  ...
  widget: json['widget'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['widget']),
  widget2: json['widget2'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['widget2']),
  widgetUrl: json['widget_url'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['widget_url']),
  widgetUrl2: json['widget_url2'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['widget_url2']),
  link: json['link'] == null
      ? ''
      : const FirestoreStringConverter().fromJson(json['link']),
...
Map<String, dynamic> _$SetupDocDtoToJson(
  _SetupDocDto instance,
) => <String, dynamic>{
