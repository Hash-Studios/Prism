...
return linksUpdated(_that);case _FetchFollowerSummariesRequested() when fetchFollowerSummariesRequested != null:
return fetchFollowerSummariesRequested(_that);case _FetchFollowingSummariesRequested() when fetchFollowingSummariesRequested != null:
return fetchFollowingSummariesRequested(_that);case _FollowFromListRequested() when followFromListRequested != null:
...
return linksUpdated(_that);case _FetchFollowerSummariesRequested():
return fetchFollowerSummariesRequested(_that);case _FetchFollowingSummariesRequested():
return fetchFollowingSummariesRequested(_that);case _FollowFromListRequested():
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email)?  started,TResult Function()?  refreshRequested,TResult Function()?  fetchMoreWallsRequested,TResult Function()?  fetchMoreSetupsRequested,TResult Function( String currentUserId,  String currentUserEmail)?  followRequested,TResult Function( String currentUserId,  String currentUserEmail)?  unfollowRequested,TResult Function( String userId,  Map<String, String> links)?  linksUpdated,TResult Function( List<String> emails,  String currentUserEmail)?  fetchFollowerSummariesRequested,TResult Function( List<String> emails,  String currentUserEmail)?  fetchFollowingSummariesRequested,TResult Function( String currentUserId,  String currentUserEmail,  String targetUserId,  String targetUserEmail)?  followFromListRequested,TResult Function( String currentUserId,  String currentUserEmail,  String targetUserId,  String targetUserEmail)?  unfollowFromListRequested,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
...
return linksUpdated(_that.userId,_that.links);case _FetchFollowerSummariesRequested() when fetchFollowerSummariesRequested != null:
return fetchFollowerSummariesRequested(_that.emails,_that.currentUserEmail);case _FetchFollowingSummariesRequested() when fetchFollowingSummariesRequested != null:
return fetchFollowingSummariesRequested(_that.emails,_that.currentUserEmail);case _FollowFromListRequested() when followFromListRequested != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email)  started,required TResult Function()  refreshRequested,required TResult Function()  fetchMoreWallsRequested,required TResult Function()  fetchMoreSetupsRequested,required TResult Function( String currentUserId,  String currentUserEmail)  followRequested,required TResult Function( String currentUserId,  String currentUserEmail)  unfollowRequested,required TResult Function( String userId,  Map<String, String> links)  linksUpdated,required TResult Function( List<String> emails,  String currentUserEmail)  fetchFollowerSummariesRequested,required TResult Function( List<String> emails,  String currentUserEmail)  fetchFollowingSummariesRequested,required TResult Function( String currentUserId,  String currentUserEmail,  String targetUserId,  String targetUserEmail)  followFromListRequested,required TResult Function( String currentUserId,  String currentUserEmail,  String targetUserId,  String targetUserEmail)  unfollowFromListRequested,}) {final _that = this;
switch (_that) {
case _Started():
...
return linksUpdated(_that.userId,_that.links);case _FetchFollowerSummariesRequested():
return fetchFollowerSummariesRequested(_that.emails,_that.currentUserEmail);case _FetchFollowingSummariesRequested():
return fetchFollowingSummariesRequested(_that.emails,_that.currentUserEmail);case _FollowFromListRequested():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email)?  started,TResult? Function()?  refreshRequested,TResult? Function()?  fetchMoreWallsRequested,TResult? Function()?  fetchMoreSetupsRequested,TResult? Function( String currentUserId,  String currentUserEmail)?  followRequested,TResult? Function( String currentUserId,  String currentUserEmail)?  unfollowRequested,TResult? Function( String userId,  Map<String, String> links)?  linksUpdated,TResult? Function( List<String> emails,  String currentUserEmail)?  fetchFollowerSummariesRequested,TResult? Function( List<String> emails,  String currentUserEmail)?  fetchFollowingSummariesRequested,TResult? Function( String currentUserId,  String currentUserEmail,  String targetUserId,  String targetUserEmail)?  followFromListRequested,TResult? Function( String currentUserId,  String currentUserEmail,  String targetUserId,  String targetUserEmail)?  unfollowFromListRequested,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that.email);case _RefreshRequested() when refreshRequested != null:
return refreshRequested();case _FetchMoreWallsRequested() when fetchMoreWallsRequested != null:
...
class _FetchFollowerSummariesRequested implements PublicProfileEvent {
  const _FetchFollowerSummariesRequested({required final  List<String> emails, required this.currentUserEmail}): _emails = emails;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$FetchFollowerSummariesRequestedCopyWith<_FetchFollowerSummariesRequested> get copyWith => __$FetchFollowerSummariesRequestedCopyWithImpl<_FetchFollowerSummariesRequested>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FetchFollowerSummariesRequested&&const DeepCollectionEquality().equals(other._emails, _emails)&&(identical(other.currentUserEmail, currentUserEmail) || other.currentUserEmail == currentUserEmail));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_emails),currentUserEmail);

@override
String toString() {
  return 'PublicProfileEvent.fetchFollowerSummariesRequested(emails: $emails, currentUserEmail: $currentUserEmail)';
}
...
/// @nodoc
abstract mixin class _$FetchFollowerSummariesRequestedCopyWith<$Res> implements $PublicProfileEventCopyWith<$Res> {
  factory _$FetchFollowerSummariesRequestedCopyWith(_FetchFollowerSummariesRequested value, $Res Function(_FetchFollowerSummariesRequested) _then) = __$FetchFollowerSummariesRequestedCopyWithImpl;
@useResult
$Res call({
 List<String> emails, String currentUserEmail
});
...
/// @nodoc
class __$FetchFollowerSummariesRequestedCopyWithImpl<$Res>
    implements _$FetchFollowerSummariesRequestedCopyWith<$Res> {
  __$FetchFollowerSummariesRequestedCopyWithImpl(this._self, this._then);

  final _FetchFollowerSummariesRequested _self;
  final $Res Function(_FetchFollowerSummariesRequested) _then;

/// Create a copy of PublicProfileEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? emails = null,Object? currentUserEmail = null,}) {
  return _then(_FetchFollowerSummariesRequested(
emails: null == emails ? _self._emails : emails // ignore: cast_nullable_to_non_nullable
...
class _FetchFollowingSummariesRequested implements PublicProfileEvent {
  const _FetchFollowingSummariesRequested({required final  List<String> emails, required this.currentUserEmail}): _emails = emails;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$FetchFollowingSummariesRequestedCopyWith<_FetchFollowingSummariesRequested> get copyWith => __$FetchFollowingSummariesRequestedCopyWithImpl<_FetchFollowingSummariesRequested>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FetchFollowingSummariesRequested&&const DeepCollectionEquality().equals(other._emails, _emails)&&(identical(other.currentUserEmail, currentUserEmail) || other.currentUserEmail == currentUserEmail));
}
...
@override
String toString() {
  return 'PublicProfileEvent.fetchFollowingSummariesRequested(emails: $emails, currentUserEmail: $currentUserEmail)';
}
...
/// @nodoc
abstract mixin class _$FetchFollowingSummariesRequestedCopyWith<$Res> implements $PublicProfileEventCopyWith<$Res> {
  factory _$FetchFollowingSummariesRequestedCopyWith(_FetchFollowingSummariesRequested value, $Res Function(_FetchFollowingSummariesRequested) _then) = __$FetchFollowingSummariesRequestedCopyWithImpl;
@useResult
$Res call({
 List<String> emails, String currentUserEmail
});
...
/// @nodoc
class __$FetchFollowingSummariesRequestedCopyWithImpl<$Res>
    implements _$FetchFollowingSummariesRequestedCopyWith<$Res> {
  __$FetchFollowingSummariesRequestedCopyWithImpl(this._self, this._then);

  final _FetchFollowingSummariesRequested _self;
  final $Res Function(_FetchFollowingSummariesRequested) _then;

/// Create a copy of PublicProfileEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? emails = null,Object? currentUserEmail = null,}) {
  return _then(_FetchFollowingSummariesRequested(
emails: null == emails ? _self._emails : emails // ignore: cast_nullable_to_non_nullable
as List<String>,currentUserEmail: null == currentUserEmail ? _self.currentUserEmail : currentUserEmail // ignore: cast_nullable_to_non_nullable
as String,
  ));
...
mixin _$PublicProfileState {
 ...
 List<UserSummaryEntity> get followerSummaries;/// Following profiles loaded for the following list screen.
 List<UserSummaryEntity> get followingSummaries;/// Whether follower/following summaries are being loaded.
 bool get isFetchingSummaries; Failure? get failure;
...
/// Create a copy of PublicProfileState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? actionStatus = null,Object? email = null,Object? profile = null,Object? walls = null,Object? setups = null,Object? hasMoreWalls = null,Object? hasMoreSetups = null,Object? wallsCursor = freezed,Object? setupsCursor = freezed,Object? isFetchingMoreWalls = null,Object? isFetchingMoreSetups = null,Object? followerSummaries = null,Object? followingSummaries = null,Object? isFetchingSummaries = null,Object? failure = freezed,}) {
...
as List<UserSummaryEntity>,isFetchingSummaries: null == isFetchingSummaries ? _self.isFetchingSummaries : isFetchingSummaries // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _PublicProfileState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.email,_that.profile,_that.walls,_that.setups,_that.hasMoreWalls,_that.hasMoreSetups,_that.wallsCursor,_that.setupsCursor,_that.isFetchingMoreWalls,_that.isFetchingMoreSetups,_that.followerSummaries,_that.followingSummaries,_that.isFetchingSummaries,_that.failure);case _:
  return orElse();
...
@override final  bool isFetchingSummaries;
...
@override
int get hashCode => Object.hash(runtimeType,status,actionStatus,email,profile,const DeepCollectionEquality().hash(_walls),const DeepCollectionEquality().hash(_setups),hasMoreWalls,hasMoreSetups,wallsCursor,setupsCursor,isFetchingMoreWalls,isFetchingMoreSetups,const DeepCollectionEquality().hash(_followerSummaries),const DeepCollectionEquality().hash(_followingSummaries),isFetchingSummaries,failure);
