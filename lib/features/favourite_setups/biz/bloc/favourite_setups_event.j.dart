...
abstract class FavouriteSetupsEvent with _$FavouriteSetupsEvent {
  ...
  const factory FavouriteSetupsEvent.toggleRequested({required FavouriteSetupEntity setup}) = _ToggleRequested;
  const factory FavouriteSetupsEvent.removeRequested({required String setupId}) = _RemoveRequested;
