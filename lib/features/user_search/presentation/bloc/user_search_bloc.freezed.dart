...
extension UserSearchEventPatterns on UserSearchEvent {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case _SearchRequested() when searchRequested != null:
        return searchRequested(_that.query);
      case _Cleared() when cleared != null:
        return cleared();
      case _:
        return orElse();
...
extension UserSearchStatePatterns on UserSearchState {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserSearchState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _UserSearchState implements UserSearchState {
  const _UserSearchState(
      {required this.status,
      required this.actionStatus,
      required this.query,
      required final List<UserSearchUser> users,
      this.failure})
      : _users = users;
