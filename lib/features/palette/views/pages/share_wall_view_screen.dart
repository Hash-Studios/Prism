...
import 'package:Prism/core/wallpaper/prism_wallpaper_view.dart';
import 'package:Prism/core/wallpaper/wallpaper_core.dart';
import 'package:Prism/core/wallpaper/wallpaper_source.dart';
import 'package:Prism/core/wallpaper/wallpaper_legacy_extensions.dart';
                                            ...
                                            children: <Widget>[
                                              Column(
                                                ...
                                                children: <Widget>[
                                                  Row(
                                                    children: [
                                                      const Icon(JamIcons.camera, size: 20, color: Colors.white70),
                                                      const SizedBox(width: 10),
                                                      SizedBox(
                                                        ...
                                                        child: Text(
                                                          PData.wall == null
                                                              ? "Photographer"
                                                              : PData.wall!.photographer.toString(),
                                                ...
                                                children: <Widget>[
                                                  Row(
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 10),
                                                      const Icon(JamIcons.info, size: 20, color: Colors.white70),
                                                    ],
                                                  ),
                                                  const SizedBox(height: 5),
                                                  Row(
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 10),
                                                      const Icon(JamIcons.database, size: 20, color: Colors.white70),
                                                    ],
                                                  ),
                                                ],
                                              ),
