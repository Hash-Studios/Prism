...
mixin _$ProfileWallsState {
 ...
 LoadStatus get status; ActionStatus get actionStatus; String get email; List<ProfileWallEntity> get items; bool get hasMore; String? get nextCursor; bool get isFetchingMore; Failure? get failure;
/// Create a copy of ProfileWallsState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ProfileWallsStateCopyWith<ProfileWallsState> get copyWith => _$ProfileWallsStateCopyWithImpl<ProfileWallsState>(this as ProfileWallsState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileWallsState&&(identical(other.status, status) || other.status == status)&&(identical(other.actionStatus, actionStatus) || other.actionStatus == actionStatus)&&(identical(other.email, email) || other.email == email)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.nextCursor, nextCursor) || other.nextCursor == nextCursor)&&(identical(other.isFetchingMore, isFetchingMore) || other.isFetchingMore == isFetchingMore)&&(identical(other.failure, failure) || other.failure == failure));
}
...
abstract mixin class $ProfileWallsStateCopyWith<$Res>  {
  factory $ProfileWallsStateCopyWith(ProfileWallsState value, $Res Function(ProfileWallsState) _then) = _$ProfileWallsStateCopyWithImpl;
@useResult
$Res call({
 LoadStatus status, ActionStatus actionStatus, String email, List<ProfileWallEntity> items, bool hasMore, String? nextCursor, bool isFetchingMore, Failure? failure
});
...
as List<ProfileWallEntity>,hasMore: null == hasMore ? _self.hasMore : hasMore // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ProfileWallsState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ProfileWallsState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ProfileWallsState value)?  $default,){
final _that = this;
switch (_that) {
case _ProfileWallsState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  String email,  List<ProfileWallEntity> items,  bool hasMore,  String? nextCursor,  bool isFetchingMore,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileWallsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  String email,  List<ProfileWallEntity> items,  bool hasMore,  String? nextCursor,  bool isFetchingMore,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _ProfileWallsState():
return $default(_that.status,_that.actionStatus,_that.email,_that.items,_that.hasMore,_that.nextCursor,_that.isFetchingMore,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LoadStatus status,  ActionStatus actionStatus,  String email,  List<ProfileWallEntity> items,  bool hasMore,  String? nextCursor,  bool isFetchingMore,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _ProfileWallsState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.email,_that.items,_that.hasMore,_that.nextCursor,_that.isFetchingMore,_that.failure);case _:
  return null;
...
class _ProfileWallsState implements ProfileWallsState {
  const _ProfileWallsState({required this.status, required this.actionStatus, required this.email, required final  List<ProfileWallEntity> items, required this.hasMore, required this.nextCursor, required this.isFetchingMore, this.failure}): _items = items;
...
@override List<ProfileWallEntity> get items {
...
@pragma('vm:prefer-inline')
_$ProfileWallsStateCopyWith<_ProfileWallsState> get copyWith => __$ProfileWallsStateCopyWithImpl<_ProfileWallsState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProfileWallsState&&(identical(other.status, status) || other.status == status)&&(identical(other.actionStatus, actionStatus) || other.actionStatus == actionStatus)&&(identical(other.email, email) || other.email == email)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.nextCursor, nextCursor) || other.nextCursor == nextCursor)&&(identical(other.isFetchingMore, isFetchingMore) || other.isFetchingMore == isFetchingMore)&&(identical(other.failure, failure) || other.failure == failure));
}
...
abstract mixin class _$ProfileWallsStateCopyWith<$Res> implements $ProfileWallsStateCopyWith<$Res> {
  factory _$ProfileWallsStateCopyWith(_ProfileWallsState value, $Res Function(_ProfileWallsState) _then) = __$ProfileWallsStateCopyWithImpl;
@override @useResult
$Res call({
 LoadStatus status, ActionStatus actionStatus, String email, List<ProfileWallEntity> items, bool hasMore, String? nextCursor, bool isFetchingMore, Failure? failure
});
