...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Started&&(identical(other.syncRemote, syncRemote) || other.syncRemote == syncRemote));
}
...
/// Create a copy of InAppNotificationsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? syncRemote = null,}) {
  return _then(_Started(
syncRemote: null == syncRemote ? _self.syncRemote : syncRemote // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$MarkReadRequestedCopyWith<_MarkReadRequested> get copyWith => __$MarkReadRequestedCopyWithImpl<_MarkReadRequested>(this, _$identity);
...
mixin _$InAppNotificationsState {
 ...
 LoadStatus get status; ActionStatus get actionStatus; List<InAppNotificationEntity> get items; int get unreadCount; Failure? get failure;
/// Create a copy of InAppNotificationsState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$InAppNotificationsStateCopyWith<InAppNotificationsState> get copyWith => _$InAppNotificationsStateCopyWithImpl<InAppNotificationsState>(this as InAppNotificationsState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InAppNotificationsState&&(identical(other.status, status) || other.status == status)&&(identical(other.actionStatus, actionStatus) || other.actionStatus == actionStatus)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.unreadCount, unreadCount) || other.unreadCount == unreadCount)&&(identical(other.failure, failure) || other.failure == failure));
}


@override
int get hashCode => Object.hash(runtimeType,status,actionStatus,const DeepCollectionEquality().hash(items),unreadCount,failure);
...
abstract mixin class $InAppNotificationsStateCopyWith<$Res>  {
  factory $InAppNotificationsStateCopyWith(InAppNotificationsState value, $Res Function(InAppNotificationsState) _then) = _$InAppNotificationsStateCopyWithImpl;
@useResult
$Res call({
 LoadStatus status, ActionStatus actionStatus, List<InAppNotificationEntity> items, int unreadCount, Failure? failure
});
...
/// Create a copy of InAppNotificationsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? actionStatus = null,Object? items = null,Object? unreadCount = null,Object? failure = freezed,}) {
...
as List<InAppNotificationEntity>,unreadCount: null == unreadCount ? _self.unreadCount : unreadCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InAppNotificationsState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _InAppNotificationsState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _InAppNotificationsState value)?  $default,){
final _that = this;
switch (_that) {
case _InAppNotificationsState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  List<InAppNotificationEntity> items,  int unreadCount,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InAppNotificationsState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.items,_that.unreadCount,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  List<InAppNotificationEntity> items,  int unreadCount,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _InAppNotificationsState():
return $default(_that.status,_that.actionStatus,_that.items,_that.unreadCount,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LoadStatus status,  ActionStatus actionStatus,  List<InAppNotificationEntity> items,  int unreadCount,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _InAppNotificationsState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.items,_that.unreadCount,_that.failure);case _:
  return null;
...
class _InAppNotificationsState implements InAppNotificationsState {
  const _InAppNotificationsState({required this.status, required this.actionStatus, required final  List<InAppNotificationEntity> items, required this.unreadCount, this.failure}): _items = items;
  

@override final  LoadStatus status;
@override final  ActionStatus actionStatus;
 final  List<InAppNotificationEntity> _items;
@override List<InAppNotificationEntity> get items {
...
@pragma('vm:prefer-inline')
_$InAppNotificationsStateCopyWith<_InAppNotificationsState> get copyWith => __$InAppNotificationsStateCopyWithImpl<_InAppNotificationsState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _InAppNotificationsState&&(identical(other.status, status) || other.status == status)&&(identical(other.actionStatus, actionStatus) || other.actionStatus == actionStatus)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.unreadCount, unreadCount) || other.unreadCount == unreadCount)&&(identical(other.failure, failure) || other.failure == failure));
}


@override
int get hashCode => Object.hash(runtimeType,status,actionStatus,const DeepCollectionEquality().hash(_items),unreadCount,failure);
...
abstract mixin class _$InAppNotificationsStateCopyWith<$Res> implements $InAppNotificationsStateCopyWith<$Res> {
  factory _$InAppNotificationsStateCopyWith(_InAppNotificationsState value, $Res Function(_InAppNotificationsState) _then) = __$InAppNotificationsStateCopyWithImpl;
@override @useResult
$Res call({
 LoadStatus status, ActionStatus actionStatus, List<InAppNotificationEntity> items, int unreadCount, Failure? failure
});
...
/// Create a copy of InAppNotificationsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? actionStatus = null,Object? items = null,Object? unreadCount = null,Object? failure = freezed,}) {
