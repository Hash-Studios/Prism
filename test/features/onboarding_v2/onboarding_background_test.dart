...
void main() {
  testWidgets('keeps a warm fill if the welcome wallpaper cannot decode', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: SizedBox(
          width: 393,
          height: 852,
          child: OnboardingBackground(assetPath: 'assets/images/does_not_exist.webp'),
        ),
      ),
    );
    await tester.pump();
