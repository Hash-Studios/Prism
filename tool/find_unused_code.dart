...
void main(List<String> args) {
  ...
  final List<String> unreachable = _findUnreachable(allFiles, reachable)..sort();
...
void _generateHtml({
  ...
  final int unusedSymbolCount = unusedSymbols.values.fold(0, (int s, List<String> l) => s + l.length);
  ...
  final List<MapEntry<String, List<String>>> sortedSymbols =
      unusedSymbols.entries
          .map((MapEntry<String, List<String>> e) => MapEntry<String, List<String>>(_rel(e.key, projectRoot), e.value))
          .toList()
        ..sort(
