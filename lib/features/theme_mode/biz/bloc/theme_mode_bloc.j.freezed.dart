...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _ModeChanged value)?  modeChanged,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _ModeChanged() when modeChanged != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _ModeChanged value)  modeChanged,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _ModeChanged():
return modeChanged(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _ModeChanged value)?  modeChanged,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _ModeChanged() when modeChanged != null:
...
mixin _$ThemeModeState {
 ...
 LoadStatus get status; ActionStatus get actionStatus; ThemeModeEntity get mode; Failure? get failure;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeModeState&&(identical(other.status, status) || other.status == status)&&(identical(other.actionStatus, actionStatus) || other.actionStatus == actionStatus)&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.failure, failure) || other.failure == failure));
}
...
@useResult
$Res call({
 LoadStatus status, ActionStatus actionStatus, ThemeModeEntity mode, Failure? failure
});
...
/// Create a copy of ThemeModeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? actionStatus = null,Object? mode = null,Object? failure = freezed,}) {
...
as ActionStatus,mode: null == mode ? _self.mode : mode // ignore: cast_nullable_to_non_nullable
as ThemeModeEntity,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  ThemeModeEntity mode,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeModeState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.mode,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  ThemeModeEntity mode,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _ThemeModeState():
return $default(_that.status,_that.actionStatus,_that.mode,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LoadStatus status,  ActionStatus actionStatus,  ThemeModeEntity mode,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _ThemeModeState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.mode,_that.failure);case _:
  return null;
...
@override final  ThemeModeEntity mode;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeModeState&&(identical(other.status, status) || other.status == status)&&(identical(other.actionStatus, actionStatus) || other.actionStatus == actionStatus)&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.failure, failure) || other.failure == failure));
}
...
/// Create a copy of ThemeModeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? actionStatus = null,Object? mode = null,Object? failure = freezed,}) {
