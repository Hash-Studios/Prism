...
class SetupImmersiveCard extends StatelessWidget {
  const SetupImmersiveCard({
    Key? key,
      ...
      child: ChangeNotifierProvider<PaletteGeneratorController>(
        ...
        child: Consumer<PaletteGeneratorController>(
          builder: (context, pgc, child) => Container(
            ...
            color: pgc.paletteGenerator?.dominantColor?.color.invert.darken20 ??
                    ...
                    child: CachedNetworkImage(
                      ...
                      imageBuilder: (context, imageProvider) => Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: pgc.paletteGenerator?.dominantColor?.color
                                    .invert ??
