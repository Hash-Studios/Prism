...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _StatusChanged value)?  statusChanged,TResult Function( _RecheckRequested value)?  recheckRequested,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _StatusChanged() when statusChanged != null:
return statusChanged(_that);case _RecheckRequested() when recheckRequested != null:
return recheckRequested(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _StatusChanged value)  statusChanged,required TResult Function( _RecheckRequested value)  recheckRequested,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _StatusChanged():
return statusChanged(_that);case _RecheckRequested():
return recheckRequested(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _StatusChanged value)?  statusChanged,TResult? Function( _RecheckRequested value)?  recheckRequested,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _StatusChanged() when statusChanged != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( ConnectivityEntity connectivity)?  statusChanged,TResult Function()?  recheckRequested,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _StatusChanged() when statusChanged != null:
return statusChanged(_that.connectivity);case _RecheckRequested() when recheckRequested != null:
return recheckRequested();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( ConnectivityEntity connectivity)  statusChanged,required TResult Function()  recheckRequested,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _StatusChanged():
return statusChanged(_that.connectivity);case _RecheckRequested():
return recheckRequested();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( ConnectivityEntity connectivity)?  statusChanged,TResult? Function()?  recheckRequested,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _StatusChanged() when statusChanged != null:
return statusChanged(_that.connectivity);case _RecheckRequested() when recheckRequested != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _StatusChanged&&(identical(other.connectivity, connectivity) || other.connectivity == connectivity));
}
...
mixin _$ConnectivityState {
 ...
 LoadStatus get status; ActionStatus get actionStatus; ConnectivityEntity get connectivity; Failure? get failure;
...
@useResult
$Res call({
 LoadStatus status, ActionStatus actionStatus, ConnectivityEntity connectivity, Failure? failure
});
...
/// Create a copy of ConnectivityState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? actionStatus = null,Object? connectivity = null,Object? failure = freezed,}) {
...
as ActionStatus,connectivity: null == connectivity ? _self.connectivity : connectivity // ignore: cast_nullable_to_non_nullable
as ConnectivityEntity,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  ConnectivityEntity connectivity,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConnectivityState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.connectivity,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LoadStatus status,  ActionStatus actionStatus,  ConnectivityEntity connectivity,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _ConnectivityState():
return $default(_that.status,_that.actionStatus,_that.connectivity,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LoadStatus status,  ActionStatus actionStatus,  ConnectivityEntity connectivity,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _ConnectivityState() when $default != null:
return $default(_that.status,_that.actionStatus,_that.connectivity,_that.failure);case _:
  return null;
...
class _ConnectivityState implements ConnectivityState {
  const _ConnectivityState({required this.status, required this.actionStatus, required this.connectivity, this.failure});
  

@override final  LoadStatus status;
@override final  ActionStatus actionStatus;
@override final  ConnectivityEntity connectivity;
...
/// Create a copy of ConnectivityState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? actionStatus = null,Object? connectivity = null,Object? failure = freezed,}) {
