...
extension ThemeLightStatePatterns on ThemeLightState {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ThemeLightState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ThemeLightState implements ThemeLightState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ThemeLightStateCopyWith<_ThemeLightState> get copyWith =>
      __$ThemeLightStateCopyWithImpl<_ThemeLightState>(this, _$identity);
