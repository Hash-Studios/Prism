  ...
  Widget build(BuildContext context) {
    ...
    final Color progressColor =
        Color.lerp(
          colorScheme.error,
          colorScheme.primary,
          widget.status.progress.clamp(0.0, 1.0),
        ) ??
        colorScheme.primary;
    final int remainingSteps =
        (widget.status.totalSteps - widget.status.completedSteps)
            .clamp(0, widget.status.totalSteps);
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                FilledButton(
                  onPressed:
                      widget.onCompleteNow == null ? null : _handleComplete,
