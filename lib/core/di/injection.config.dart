...
import '../../features/category_feed/domain/usecases/category_feed_usecases.dart'
    as _i301;
import '../../features/category_feed/presentation/bloc/category_feed_bloc.dart'
    as _i130;
...
import '../../features/deep_link/domain/usecases/deep_link_usecases.dart'
    as _i663;
import '../../features/deep_link/presentation/bloc/deep_link_bloc.dart'
    as _i687;
...
import '../../features/favourite_setups/domain/usecases/favourite_setups_usecases.dart'
    as _i340;
import '../../features/favourite_setups/presentation/bloc/favourite_setups_bloc.dart'
    as _i826;
...
import '../../features/favourite_walls/domain/usecases/favourite_walls_usecases.dart'
    as _i406;
import '../../features/favourite_walls/presentation/bloc/favourite_walls_bloc.dart'
    as _i526;
...
import '../../features/in_app_notifications/domain/usecases/notifications_usecases.dart'
    as _i474;
import '../../features/in_app_notifications/presentation/bloc/in_app_notifications_bloc.dart'
    as _i116;
...
import '../../features/profile_setups/domain/usecases/profile_setups_usecases.dart'
    as _i272;
import '../../features/profile_setups/presentation/bloc/profile_setups_bloc.dart'
    as _i204;
...
import '../../features/profile_walls/domain/usecases/profile_walls_usecases.dart'
    as _i58;
import '../../features/profile_walls/presentation/bloc/profile_walls_bloc.dart'
    as _i1031;
...
import '../../features/public_profile/domain/usecases/public_profile_usecases.dart'
    as _i446;
import '../../features/public_profile/presentation/bloc/public_profile_bloc.dart'
    as _i57;
...
import '../../features/quick_actions/domain/usecases/quick_actions_usecases.dart'
    as _i108;
import '../../features/quick_actions/presentation/bloc/quick_actions_bloc.dart'
    as _i955;
...
import '../../features/theme_dark/domain/usecases/theme_dark_usecases.dart'
    as _i96;
import '../../features/theme_dark/presentation/bloc/theme_dark_bloc.dart'
    as _i393;
...
import '../../features/theme_light/domain/usecases/theme_light_usecases.dart'
    as _i518;
import '../../features/theme_light/presentation/bloc/theme_light_bloc.dart'
    as _i167;
import '../../features/theme_mode/domain/usecases/theme_mode_usecases.dart'
    as _i836;
import '../../features/theme_mode/presentation/bloc/theme_mode_bloc.dart'
    as _i777;
...
_i174.GetIt initGetIt(
  ...
  gh.lazySingleton<_i366.NotificationsRepository>(() =>
      _i1017.NotificationsRepositoryImpl(gh<_i979.Box<_i1047.InAppNotif>>(
          instanceName: 'inAppNotificationsBox')));
  ...
  gh.lazySingleton<_i204.UserSearchRepository>(
      () => _i352.UserSearchRepositoryImpl(gh<_i974.FirebaseFirestore>()));
  ...
  gh.lazySingleton<_i425.ThemeRepository>(() => _i404.ThemeRepositoryImpl(
      gh<_i979.Box<dynamic>>(instanceName: 'prefsBox')));
  gh.lazySingleton<_i411.SetupsRepository>(
      () => _i415.SetupsRepositoryImpl(gh<_i974.FirebaseFirestore>()));
  ...
  gh.lazySingleton<_i668.ProfileWallsRepository>(
      () => _i409.ProfileWallsRepositoryImpl(gh<_i974.FirebaseFirestore>()));
  ...
  gh.factory<_i627.PaletteBloc>(
      () => _i627.PaletteBloc(gh<_i576.GeneratePaletteUseCase>()));
  ...
  gh.factory<_i509.StartupBloc>(
      () => _i509.StartupBloc(gh<_i415.BootstrapAppUseCase>()));
  ...
  gh.factory<_i868.SetupsBloc>(
      () => _i868.SetupsBloc(gh<_i247.FetchSetupsUseCase>()));
  ...
  gh.factory<_i1031.ProfileWallsBloc>(
      () => _i1031.ProfileWallsBloc(gh<_i58.FetchProfileWallsUseCase>()));
  gh.factory<_i204.ProfileSetupsBloc>(
      () => _i204.ProfileSetupsBloc(gh<_i272.FetchProfileSetupsUseCase>()));
  gh.factory<_i830.UserSearchBloc>(
      () => _i830.UserSearchBloc(gh<_i750.SearchUsersUseCase>()));
