...
mixin _$ProfileSetupsState {
  ...
  String get email;
  List<ProfileSetupEntity> get items;
  bool get hasMore;
...
extension ProfileSetupsStatePatterns on ProfileSetupsState {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ProfileSetupsState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ProfileSetupsState implements ProfileSetupsState {
  const _ProfileSetupsState(
      {required this.status,
      required this.actionStatus,
      required this.email,
      required final List<ProfileSetupEntity> items,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProfileSetupsStateCopyWith<_ProfileSetupsState> get copyWith =>
      __$ProfileSetupsStateCopyWithImpl<_ProfileSetupsState>(this, _$identity);
