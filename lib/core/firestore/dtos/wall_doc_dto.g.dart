...
_FavouriteWallDocDto _$FavouriteWallDocDtoFromJson(Map<String, dynamic> json) => _FavouriteWallDocDto(
  id: json['id'] == null ? '' : const FirestoreStringConverter().fromJson(json['id']),
  provider: json['provider'] == null ? '' : const FirestoreStringConverter().fromJson(json['provider']),
  url: json['url'] == null ? '' : const FirestoreStringConverter().fromJson(json['url']),
  thumb: json['thumb'] == null ? '' : const FirestoreStringConverter().fromJson(json['thumb']),
  category: json['category'] == null ? '' : const FirestoreStringConverter().fromJson(json['category']),
  views: json['views'] == null ? '' : const FirestoreStringConverter().fromJson(json['views']),
  resolution: json['resolution'] == null ? '' : const FirestoreStringConverter().fromJson(json['resolution']),
  fav: json['fav'] == null ? '' : const FirestoreStringConverter().fromJson(json['fav']),
  size: json['size'] == null ? '' : const FirestoreStringConverter().fromJson(json['size']),
  photographer: json['photographer'] == null ? '' : const FirestoreStringConverter().fromJson(json['photographer']),
  collections: json['collections'] == null
      ? const <String>[]
      : const FirestoreStringListConverter().fromJson(json['collections']),
  createdAt: const FirestoreDateTimeConverter().fromJson(json['createdAt']),
