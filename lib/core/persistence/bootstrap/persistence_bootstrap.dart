...
class PersistenceBootstrap {
  ...
  static Future<void> initialize() async {
    const String rawBackend = String.fromEnvironment('LOCAL_PERSISTENCE_BACKEND', defaultValue: 'shared_prefs');
    final LocalStoreBackend backend = LocalStoreBackendX.fromDefine(rawBackend);
