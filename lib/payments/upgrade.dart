...
Future<void> initPlatformState() async {
  ...
  try {
    ...
    if (purchaserInfo.entitlements.all['prism_pro'] != null) {
      appData.isPro = purchaserInfo.entitlements.all['prism_pro'].isActive;
    } else {
      appData.isPro = false;
    }
  ...
  Widget build(BuildContext context) {
    if (_purchaserInfo == null) {
      ...
      if (_purchaserInfo.entitlements.all.isNotEmpty &&
          _purchaserInfo.entitlements.all['prism_pro'].isActive != null) {
        appData.isPro = _purchaserInfo.entitlements.all['prism_pro'].isActive;
      } else {
        appData.isPro = false;
      }
      if (appData.isPro) {
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () async {
                      try {
                        ...
                        appData.isPro =
                            restoredInfo.entitlements.all["prism_pro"].isActive;
              ...
              child: RaisedButton(
                onPressed: () async {
                  try {
                    ...
                    appData.isPro =
                        _purchaserInfo.entitlements.all["prism_pro"].isActive;
