...
_PrismWallDocDto _$PrismWallDocDtoFromJson(Map<String, dynamic> json) =>
    _PrismWallDocDto(
      id: json['id'] == null
          ? ''
      ...
      wallpaperProvider: json['wallpaper_provider'] == null
          ? ''
          : const FirestoreStringConverter().fromJson(
              json['wallpaper_provider'],
            ),
      ...
      uploadedBy: json['uploadedBy'] == null
          ? ''
          : const FirestoreStringConverter().fromJson(json['uploadedBy']),
      by: json['by'] == null
          ? ''
      ...
      tags: json['tags'] == null
          ? const <String>[]
          : const FirestoreStringListConverter().fromJson(json['tags']),
...
Map<String, dynamic> _$PrismWallDocDtoToJson(
  _PrismWallDocDto instance,
) => <String, dynamic>{
