...
abstract class PrismWallDocDto with _$PrismWallDocDto {
  const factory PrismWallDocDto({
    ...
    @JsonKey(name: 'wallpaper_url')
    @FirestoreStringConverter()
    @Default('')
    String wallpaperUrl,
    @JsonKey(name: 'wallpaper_thumb')
    @FirestoreStringConverter()
    @Default('')
    String wallpaperThumb,
    @JsonKey(name: 'wallpaper_provider')
    @FirestoreStringConverter()
    @Default('')
    ...
    @JsonKey(name: 'is_streak_exclusive')
    @Default(false)
    bool isStreakExclusive,
    @JsonKey(name: 'required_streak_days') int? requiredStreakDays,
    @JsonKey(name: 'streak_shop_coin_cost') int? streakShopCoinCost,
  }) = _PrismWallDocDto;

  factory PrismWallDocDto.fromJson(Map<String, dynamic> json) =>
      _$PrismWallDocDtoFromJson(json);
}
