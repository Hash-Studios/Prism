...
class TrendingWallpaperScreen extends StatefulWidget {
  final List arguments;
  const TrendingWallpaperScreen({@required this.arguments});
  @override
  _TrendingWallpaperScreenState createState() =>
      _TrendingWallpaperScreenState();
}

class _TrendingWallpaperScreenState extends State<TrendingWallpaperScreen>
  ...
  void initState() {
    ...
    isLoading = true;
    updateViews(data.subSortedData[index]["id"].toString().toUpperCase());
    _futureView =
        getViews(data.subSortedData[index]["id"].toString().toUpperCase());
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        data.subSortedData[index]["resolution"]
                                            .toString(),
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyText2
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      await createCopyrightLink(false, context,
                                          id: data.subSortedData[index]["id"]
                                              .toString(),
                                          provider: provider,
                                          url: data.subSortedData[index]
                                                  ["wallpaper_url"]
                                              .toString(),
                                          thumbUrl: data.subSortedData[index]
                                                  ["wallpaper_thumb"]
                                              .toString());
                                    },
                                    child: Row(
                          ...
                          children: <Widget>[
                            DownloadButton(
                                ...
                                link: screenshotTaken
                                    ? _imageFile.path
                                    : data.subSortedData[index]["wallpaper_url"]
                                        .toString()),
                            SetWallpaperButton(
                                colorChanged: colorChanged,
                                url: screenshotTaken
                            ...
                            FavouriteWallpaperButton(
                              id: data.subSortedData[index]["id"].toString(),
                              provider: "Prism",
                              prism: data.subSortedData[index] as Map,
                              trash: false,
                            ),
                            ShareButton(
                                id: data.subSortedData[index]["id"].toString(),
                                provider: provider,
                                url: data.subSortedData[index]["wallpaper_url"]
                                    .toString(),
                                thumbUrl: data.subSortedData[index]
                                        ["wallpaper_thumb"]
                                    .toString()),
            ...
            children: <Widget>[
                  ...
                  builder: (buildContext, child) {
                    ...
                    return GestureDetector(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: data.subSortedData[index]["wallpaper_url"]
                            .toString(),
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: IconButton(
                    onPressed: () {
                      final link = data.subSortedData[index]["wallpaper_url"];
                      Navigator.push(
                          context,
                          PageRouteBuilder(
                              transitionDuration:
